const Settings = (() => {
    ...
    const URLS = {
        buy_pro: "https://checkout.freemius.com/app/39189/",
        website: "https://keyboardtalks.pages.dev",
        github: "https://github.com/Sallu6767/KeyboardTalks",
        privacy: "https://keyboardtalks.pages.dev/privacy",
    };
    ...
    function init() {
        ...
        setupBuyLink();
        setupExternalLinks();
        setupTurnOffButtonSettings();
        subscribeToState();
    }

    function setupTurnOffButtonSettings() {
        const btn = document.getElementById("btn-turn-off-settings");
        if (!btn) return;
    ...
    function updateProStatus() {
        ...
        if (isPro) {
            dot.className = "w-2 h-2 bg-[#4ADE80]";
            ...
            if (btn) {
                ...
                btn.classList.remove("hover:bg-[#22C55E]");
            }
            ...
            dot.className = "w-2 h-2 bg-[#94A3B8]";
            ...
            if (btn) {
                ...
                btn.classList.add("hover:bg-[#22C55E]");
            }
        }
    }
    ...
    function showMessage(text, type) {
        ...
        message.classList.add(type === "success" ? "text-[#4ADE80]" : "text-[#EF4444]");
    }
