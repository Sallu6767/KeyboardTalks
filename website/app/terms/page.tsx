      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed font-semibold text-[#4ADE80]">
            We offer a no-questions-asked refund within three (3) days of your purchase. To request a refund, please contact us at linglanboss2@gmail.com with your order email.
          </p>
        </section>
