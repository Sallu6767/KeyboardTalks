    ...
    <div className="min-h-screen bg-[#0A1128] text-[#94A3B8] py-16 px-4">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed">
            The application operates entirely offline, except during the single, one-time license key validation process with our merchant of record, Freemius.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed">
            When you purchase our Pro Pass, billing information, email address, and payment details are processed securely by our reseller, <strong>Freemius</strong>. We do not store or have access to your raw credit card numbers or banking information. We only receive your purchase email and the associated license activation status.
          </p>
        </section>
