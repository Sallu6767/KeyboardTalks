    ...
    <div className="min-h-screen bg-gray-950 text-gray-300 py-16 px-4">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed font-semibold text-indigo-300">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed">
            If you have any questions or concerns about your privacy, feel free to contact us at: <a href="mailto:linglanboss2@gmail.com" className="text-indigo-400 hover:text-indigo-300 underline">linglanboss2@gmail.com</a>.
          </p>
        </section>
