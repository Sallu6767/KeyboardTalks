...
const FAQ_ITEMS: FAQItem[] = [
    {
        ...
        answer:
            "Absolutely Safe. KeyboardTalks only listens to which KEY was pressed — not what you type. It never records, stores, or sends your keystrokes anywhere. The app needs no internet connection except for one-time license validation with Freemius. All your data stays on your own PC. The source code is open on GitHub so you can verify this yourself.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "You buy a Pro Pass once for $5.99 on this website. Freemius (our payment processor) sends a license key to your email immediately after purchase. You open the KeyboardTalks app, go to the Settings tab or use the Activate button on the home screen, paste your key, and click Activate. Pro features unlock instantly — no ongoing subscription, no recurring charges.",
    },
    {
        question: "Can I buy on my phone and use on my PC?",
        answer:
            "Yes, this is fully supported and a common flow. Visit this website on your phone, click Get Pro Pass, complete the purchase. Freemius emails you a license key. Later, open KeyboardTalks on your PC, paste the key in the app, and activate. The license key is just a text string — it works on any device.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "Check your email inbox (and spam folder) for the purchase confirmation from Freemius. That email always contains your license key. If you still cannot find it, email us at linglanboss2@gmail.com with your purchase email and we will retrieve it for you.",
    },
    {
    ...
    },
    {
        ...
        answer:
            "Yes. We offer a no-questions-asked refund within 7 days of purchase. Email us at linglanboss2@gmail.com with your order details and we will process it promptly. The free tier is fully functional, so we encourage you to try it before purchasing Pro.",
    },
];
