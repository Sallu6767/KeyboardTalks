...
export default function WebDemo() {
  ...
  const getKeySizeClass = (size: string) => {
    switch (size) {
      case "wide":
        return "flex-1 min-w-[70px] sm:min-w-[85px] bg-gray-800 hover:bg-gray-700 text-[10px] font-bold text-gray-400";
      case "extra-wide":
        return "flex-1 min-w-[80px] sm:min-w-[100px] bg-gray-800 hover:bg-gray-700 text-[10px] font-bold text-gray-400";
      case "spacebar":
        return "w-full max-w-[280px] sm:max-w-[400px] bg-indigo-950/40 border-indigo-900 text-indigo-400 text-xs py-2.5 font-black uppercase tracking-wider";
      default:
        return "w-8 h-8 sm:w-10 sm:h-10 text-xs font-semibold text-gray-400";
    }
  };
    ...
    <section className="py-20 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl
          ...
          <div className="p-6">
            ...
            {isLoading && (
              <div className="flex items-center justify-center gap-2 mb-4
                ...
                <div className="w-3.5 h-3.5 border-2 border-indigo-500
            ...
            {loadError && !isLoading && (
              <div className="mb-4 text-xs text-red-400 text-center font-medium">
            ...
            {!isFocused && (
              <div className="mb-3 text-center">
                <span className="text-xs text-indigo-400 font-bold
                                 bg-indigo-950/45 px-3 py-1 rounded-full
                                 border border-indigo-900/50 animate-pulse">
          ...
          <div className="px-6 pb-4 pt-2 border-t border-gray-800/40
                          bg-gray-950/20">
                    ...
                    return (
                      <div
                        ...
                        className={`
                          ...
                          rounded-lg border transition-all duration-75 select-none
                          ${isPressed
                            ? "bg-indigo-600 border-indigo-400 text-white scale-95 shadow-md shadow-indigo-500/30"
          ...
          <div className="mx-6 mb-6 bg-gradient-to-r from-indigo-950/60
                          to-purple-950/60 border border-indigo-800/50
                          rounded-xl p-4">
            <p className="text-center text-sm text-indigo-200">
              <span className="font-bold text-indigo-300">✨ Like this?</span>{" "}
          ...
          <div className="px-6 py-4 border-t border-gray-800 bg-gray-950/30">
        ...
        <p className="mt-4 text-center text-xs text-gray-600 leading-relaxed">
          ...
          <span className="text-gray-400 font-semibold">~3-8ms latency</span>.
        </p>
      </div>
    </section>
  );
