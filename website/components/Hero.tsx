...
useEffect(() => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col items-center
                        justify-center px-4 py-20 overflow-hidden">

      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2
                        w-96 h-96 bg-indigo-600/10 rounded-full blur-3xl" />
        <div className="absolute top-1/3 left-1/4
                        w-64 h-64 bg-purple-600/10 rounded-full blur-3xl" />
      </div>

      <div className="relative mb-6 flex items-center gap-2 px-3 py-1.5
      ...
      <h1 className="relative text-center text-4xl sm:text-5xl md:text-6xl
                     font-black tracking-tight text-white max-w-3xl
                     leading-tight">
        Make Every Keystroke
        <span className="block bg-gradient-to-r from-indigo-400 to-purple-400
                         bg-clip-text text-transparent">
          Satisfying
        </span>
      </h1>

      <p className="relative mt-6 text-center text-gray-400 text-lg
      ...
      <div className="relative mt-10 flex flex-col sm:flex-row gap-3
        ...
        <a
          ...
          className="flex items-center justify-center gap-2
                     flex-1 px-6 py-3.5 bg-indigo-600 hover:bg-indigo-500
        ...
        <a
          href={linuxUrl}
          className="flex items-center justify-center gap-2
                     flex-1 px-6 py-3.5 bg-gray-800 hover:bg-gray-700
                     text-white font-bold rounded-xl transition-all duration-200
      ...
      <div className="relative mt-20 grid grid-cols-2 sm:grid-cols-4
