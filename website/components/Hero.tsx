    ...
    return (
        <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-white/5" />
                <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-white/5" />
            </div>

            <div className="relative mb-6 flex items-center gap-2 px-3 py-1.5 bg-[#18181B] border border-[#27272A] text-xs text-[#A1A1AA]">
            ...
            <p className="relative mt-6 text-center text-[#A1A1AA] text-lg max-w-xl leading-relaxed">
            ...
            <div className="relative mt-10 flex flex-col sm:flex-row gap-3 w-full max-w-md">
                ...
                <a
                    href={windowsUrl}
                    className="flex items-center justify-center gap-2 flex-1 px-6 py-3.5 bg-white hover:bg-[#E2E8F0] text-[#09090B] font-bold transition-all duration-200 hover:-translate-y-0.5"
                >
                    <WindowsIcon />
                    <div className="text-left">
                        <div className="text-sm font-bold">Download for Windows</div>
                        <div className="text-xs text-[#09090B] font-normal">
                ...
                <a
                    href={linuxUrl}
                    className="flex items-center justify-center gap-2 flex-1 px-6 py-3.5 bg-[#18181B] hover:bg-[#27272A] text-white font-bold transition-all duration-200 border border-[#27272A] hover:border-[#3F3F46] hover:-translate-y-0.5"
                >
                    <LinuxIcon />
                    <div className="text-left">
            ...
            <p className="relative mt-4 text-xs text-[#A1A1AA]">
            ...
            <div className="relative mt-20 grid grid-cols-2 sm:grid-cols-4 gap-4 w-full max-w-2xl">
                {[
                    ...
                    <div
                        key={feature.label}
                        className="flex flex-col items-center gap-2 p-4 bg-[#18181B] border border-[#27272A] text-center"
                    >
                        <span className="text-2xl">{feature.icon}</span>
                        <span className="text-xs text-[#A1A1AA]">{feature.label}</span>
                    </div>
                ))}
            </div>
