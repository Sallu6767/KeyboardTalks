...
pub struct AppConfig {
    ...
    pub has_seen_autostart_notice: bool,
}
...
impl Default for AppConfig {
    fn default() -> Self {
        Self {
            ...
            is_turned_off: false,
            has_seen_autostart_notice: false,
        }
    }
}
...
pub fn init() {
    ...
    println!(
        "Config loaded: soundpack={}, volume={}, muted={}, pro={}, turned_off={}, seen_notice={}",
        config.active_soundpack,
        config.volume,
        config.muted,
        config.is_pro,
        config.is_turned_off,
        config.has_seen_autostart_notice
    );
}
